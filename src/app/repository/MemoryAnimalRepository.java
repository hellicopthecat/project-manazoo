...
/**
 * 메모리 기반 동물 Repository 구현체입니다. 동물 데이터를 Map에 저장하여 빠른 조회와 조작을 제공합니다. Singleton
 * 패턴을 적용하여 애플리케이션 전체에서 단일 데이터 저장소를 사용합니다.
 * 
 * <p>
 * 주요 특징:
 * </p>
...
public class MemoryAnimalRepository implements AnimalRepository {
	...
	/**
	 * Initialization-on-demand holder pattern을 사용한 Thread-safe Singleton JVM의 클래스
	 * 로딩 메커니즘을 활용하여 동기화 오버헤드 없이 lazy loading 구현
	 */
	...
	/**
	 * Singleton 인스턴스를 반환합니다. Holder Pattern을 사용하여 최적의 성능과 Thread Safety를 보장합니다.
	 * 
