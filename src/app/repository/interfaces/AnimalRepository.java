...
/**
 * Animal 엔티티를 위한 특화된 Repository 인터페이스입니다.
 * 기본 CRUD 연산 외에 Animal 도메인 특화 기능을 제공합니다.
 * 
 * <p>주요 기능:</p>
 * <ul>
 *   <li>동물 등록 및 기본 관리</li>
...
public interface AnimalRepository extends Repository<Animal, String> {
     ...
     * @return 생성된 동물 객체
     */
    Animal createAnimal(String id, String name, String species, int age,
                       String gender, String healthStatus, String enclosureId, String zkId);
